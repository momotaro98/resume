...
- 英会話を必要とする業務の経験を過去2つの職歴とも経験している
- Qiita、技術ブロクへの投稿や[ISUCON](https://isucon.net/)への連続参加を通して継続的な学習をしている
...
[技術的課題]  
* 決済代行サービスに依存しない形で決済データをどのように抽象化設計するか
